...
The Research Spaces API provides endpoints for managing multi-tenant research spaces, memberships, and associated data sources. This API enables the MED13 Resource Library to support multiple research spaces (e.g., MED13, MED12, MED14) with isolated data and team management.
